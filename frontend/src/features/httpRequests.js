...
const httpRequests = {
    ...
    uploadImageToDirectory: async (API_URL, imagesData, token) => {
        const response = await axios.post(API_URL, imagesData, configAuth(token))
        return response.data
    }
}
